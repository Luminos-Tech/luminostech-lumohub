 ...
 * ============================================================================ */
#define LUMO_FW_VERSION_STRING  "v0.5.6-fix-stack-overflow"   /* Fix stack overflow in app_main: +main task stack 16 KB, audio_play buffers -> static, audio I2S0 -> I2S1 */
